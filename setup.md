Setup Guide for Amita Shukla Blog (Hugo + Gokarna Theme)

This repository contains the source for amitashukla.in, a Hugo blog using the Gokarna theme. The setup is designed to work out of the box on any system using Docker.
